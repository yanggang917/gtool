...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        setGrid: function (grid)
        {
           ...
           var _grid = g.grid = g.gridManager = gridPanel.ligerGrid(grid);
                ...
                $("div", containerBtn1).ligerButton({
                    ...
                    click: function () { 
                       ...
                       $.each(rules,function(i,obj){
                        ...
                        //g.grid.setParm($.ligerui.toJSON(param));
                        //g.grid.reload();
                       var page = g.grid.options.page;
                       var size = g.grid.options.pageSize;
                       param["page"] = page-1;
                       param["size"] = size;
                       g.grid.loadServerData(param);
                    }
                });
